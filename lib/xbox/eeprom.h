...
#define VIDEO_STANDARD_NTSC_M 0x00400100
#define VIDEO_STANDARD_NTSC_J 0x00400200
#define VIDEO_STANDARD_PAL_I  0x00800300
#define VIDEO_STANDARD_PAL_M  0x00400400

#define VIDEO_SETTINGS_480P       0x00080000
#define VIDEO_SETTINGS_720P       0x00020000
#define VIDEO_SETTINGS_1080I      0x00040000
#define VIDEO_SETTINGS_WIDESCREEN 0x00010000
#define VIDEO_SETTINGS_LETTERBOX  0x00100000
#define VIDEO_SETTINGS_60HZ       0x00400000
#define VIDEO_SETTINGS_50HZ       0x00800000

#define AUDIO_SETTINGS_STEREO        0x00000000
#define AUDIO_SETTINGS_MONO          0x00000001
#define AUDIO_SETTINGS_SURROUND      0x00000002
#define AUDIO_SETTINGS_SURROUND_AC3  0x00010000
#define AUDIO_SETTINGS_SURROUND_DTS3 0x00020000
